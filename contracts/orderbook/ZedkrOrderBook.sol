...
contract ZedkrOrderBook is Ownable, ReentrancyGuard {
    ...
    IZedkrOrderBookFactory public immutable marketFactory;
    ...
    constructor(
        ...
        marketFactory = IZedkrOrderBookFactory(_marketFactory);
        treasury = _treasury;
    ...
    function _marketCollateral(address market) internal view returns (address collateral, uint8 colDec) {
        IZedkrMarketCollateral m = IZedkrMarketCollateral(market);
