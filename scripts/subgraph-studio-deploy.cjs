 ...
 *
 * Optional:
 *   STUDIO_SUBGRAPH_SLUG (default zedkr-testnet)
...
const slug = process.env.STUDIO_SUBGRAPH_SLUG ?? "zedkr-testnet";
...
Try:
  ...
  3. PowerShell:
       ...
       $env:STUDIO_SUBGRAPH_SLUG="zedkr_testnet"
  ...
  4. Or deploy from subgraph folder:
       ...
       npx graph deploy zedkr_testnet subgraph.yaml --version-label v0.08
